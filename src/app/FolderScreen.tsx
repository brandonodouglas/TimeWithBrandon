...
export default function FolderScreen() {
  ...
  if (globalStoredFolders.length != 0) {
    console.log('There are currently: ' + globalStoredFolders.length + ' folders in the database, loading them now')
  ...
  // When there's folders in the database
    ...
    console.log(globalStoredFolders)
     if (!editing) {
      return (<View style={{ justifyContent: 'center', padding: 20 }}>
